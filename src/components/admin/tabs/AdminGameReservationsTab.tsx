    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-purple-50 to-pink-50 p-6">
      ...
      <div className="flex flex-col lg:flex-row gap-4 md:gap-6 animate-fadeIn">
        ...
        <div className="w-full lg:w-80 flex-shrink-0">
          <div className={`fixed lg:sticky top-0 left-0 h-screen lg:h-auto w-full lg:w-80 bg-white/90 backdrop-blur-xl border border-white/20 rounded-2xl shadow-lg p-4 md:p-6 z-40 transition-transform duration-300 ${
